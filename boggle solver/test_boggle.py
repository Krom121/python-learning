...
class TestBoggle(unittest.TestCase):
    ...
    def test_can_create_an_empty_grid(self):
        """
        test to see if we can createan empty grid
        """
    ...
    def test_grid_size_is_width_times_height(self):
        """
        test is to ensure that the total size of the
        grid is equal to width * height
        """
    ...
    def test_grid_is_filled_with_letters(self):
        """
        ensure that each of the coordinates
        in the grid contains letters
        """
        grid = boggle.make_grid(2,3)
    ...
    def test_neighbours_of_a_position(self):
       """
       ensures that a position has 8 neighbours
       """
       coords = (1, 2)
    ...
    def test_converting_a_path_to_a_word(self):
        """
        ensure that paths can be convert to words
        """
    ...
    def test_search_grid_for_words(self):
     """
     ensure that certain patterns can be found
     """
    ...
    def test_load_dictionary(self):
        """
        test that the dictionary retuns a dictionary
        """
